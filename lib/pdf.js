...
function buildHtml(report, company, signatureDataUrl) {
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .hdr{background:#4A7FAF;color:#fff;display:flex;justify-content:space-between;align-items:center;padding:4px 10px}
  .hdr-icons{display:flex;gap:10px;margin-bottom:2px}
  .hi{text-align:center;font-size:5pt;color:#dce8f3}
  .hi b{display:block;font-size:9pt;margin-bottom:1px}
  .hr2{text-align:right;line-height:1.5;font-size:7pt;color:#dce8f3}
  .hf{font-size:11pt;font-weight:900;color:#fff;display:block;letter-spacing:.5px}
  .rbar{background:#C0392B;height:3px;margin-bottom:5px}
