...
function generateReportPdfBuffer(report, company) {
  return new Promise((resolve, reject) => {
    ...
    // Ab hier laesst pdfkit den Textfluss selbst verwalten (doc.y), damit bei
    // langen Berichten automatisch und ohne Inhaltsverlust eine neue Seite
    // begonnen wird, statt Text am Seitenende abzuschneiden.
    doc.y = 110;
    ...
    // Fusszeile direkt im Anschluss an den Inhalt (nicht fix am Seitenende,
    // damit bei Seitenumbruch nichts ueberlappt)
    doc.moveDown(1);
    doc
      .moveTo(50, doc.y)
